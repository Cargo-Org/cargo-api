...
namespace Cargo.Features.Documents.GetUploadUrl;

public class GetUploadUrlQueryHandler : IQueryHandler<GetUploadUrlQuery, GetUploadUrlResponse>
{
    private readonly CustomerDbContext _context;
    private readonly IStorageService _storageService;

    public GetUploadUrlQueryHandler(CustomerDbContext context, IStorageService storageService)
    {
        _context = context;
