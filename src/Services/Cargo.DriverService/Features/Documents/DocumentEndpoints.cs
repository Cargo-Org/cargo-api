...
using Cargo.DriverService.Features.Documents.GetMyDocuments;
using Cargo.DriverService.Features.Documents.GetUploadUrl;
using Cargo.DriverService.Features.Documents.RegisterDocument;
using Cargo.DriverService.Features.Documents.ReviewDocument;
using MediatR;
using Microsoft.AspNetCore.Mvc;
using System.Security.Claims;

namespace Cargo.DriverService.Features.Documents;
...
public static class DocumentEndpoints
{
        ...
        this IEndpointRouteBuilder app)
    {
        ...
        app.MapGet("/me/documents/upload-url", async (
            [FromQuery] DriverDocumentType documentType,
        ...
        .WithSummary("List all documents for the authenticated driver")
        .WithDescription(
        ...
        .WithDescription(
            ...
            "the driver's onboarding status atomically.");
