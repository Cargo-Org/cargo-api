...
public sealed class DriverProfile
{
    ...
    public static DriverProfile CreateForEmailRegistration(
    ...
    public static DriverProfile CreateForSocialLogin(
        string keycloakUserId,
        string email)
    {
        return new DriverProfile
    ...
    public void RecomputeOnboardingStatus(
        IReadOnlyList<DriverDocument>? documents = null)
    {
        ...
        // ProfilePhoto is optional — not in this list
